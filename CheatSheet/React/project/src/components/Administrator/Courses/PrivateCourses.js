...
import { CreateCourseTopicsModal } from "../Helper components/CreateCourseTopicsModal";
...
export const PrivateCourses = () => {
    ...
    const Table = ({ topics }) => {
        ...
        const isTopicModalOpen = useCreateTopicsModalStore((state) => state.isTopicModalOpen);
                        ...
                        <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                                ...
                                                <tr key={topic.topicId}>
                                                    ...
                                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                        <button className="px-1 py-1 text-gray-500 transition-colors duration-200 rounded-lg dark:text-gray-300 hover:bg-gray-100"
                                                            onClick={() => {setModalIsOpen();setTopicId(topic.topicId)}}>
                                    ...
                                    {isModalOpen && topicId && <Modal topicId={topicId} />}
                                    {isCreateModalOpen && <CreateCourseModal />}
                                    {isTopicModalOpen && <CreateCourseTopicsModal selectedCourse={selectedCourseName} />}
                                </div>
                            </div>
                        </div>
                    </div>
