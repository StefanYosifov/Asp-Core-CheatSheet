...
export const Footer = () => {
    return (
        <footer className="bg-gradient-to-l from-bgBlackUI-0 to to-bgNearBlackUI-0 sticky top-[100vh]">
            <div className="container p-6 mx-auto">
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6">
                            <section className="flex ">
                                <img className="w-96 h-36 object-cover rounded-3xl" src={logo} alt=""/>
                            </section>
